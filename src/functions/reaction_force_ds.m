function [Fx1,Fy1,Fz1,Mx1,My1,Mz1,Fx2,Fy2,Fz2,Mx2,My2,Mz2] = reaction_force_ds(body_xi,body_yi,body_zi,joint_poses,joint_rot_matrices,body_joints,l_list,xg_list,xxi,yyi,zzi,mi,tss)
    ...
    body = find(body_ids == "hip");
    [dxB, dyB, dzB, dxG, dyG, dzG, ddxG, ddyG, ddzG, ddyB, ddzB, theta, phi, omega_x, omega_y, omega_z, domega_x, domega_y, domega_z] = body_motion(joint_poses,joint_rot_matrices,body,body_joints,l_list,xg_list,tss,body_xi,body_yi,body_zi);
    [XAl,YAl,ZAl,XAr,YAr,ZAr,LAl,MAl,NAl,LAr,MAr,NAr] = hip_dyna_ds(body,XA,YA,ZA,LA,MA,NA,dxB, dyB, dzB, dxG, dyG, dzG, ddxG, ddyG, ddzG, ddyB, ddzB, theta, phi, omega_x, omega_y, omega_z, domega_x, domega_y, domega_z,xxi,yyi,zzi,mi,l_list,xg_list,N,joint_poses,body_xi,body_yi,body_zi);
